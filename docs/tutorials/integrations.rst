...
==============================
TODO: these all should be doc ref links, not github links!

These classes provide default implementations for some most popular VQAs, but are very modular and can be used with other methods listed here (e.g. you can use different ansatzes or optimizers with QAOA).
...
.. include:: ../guides/circuit_runners.rst
  :start-after: .. _integrated_circuit_runners:
